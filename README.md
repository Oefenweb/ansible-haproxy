...
* `haproxy_global_raw_options`: [default: []]: additional arbitrary lines to insert in the global section
...
* `haproxy_default_raw_options`: [default: []]: additional arbitrary lines to insert in the default section
